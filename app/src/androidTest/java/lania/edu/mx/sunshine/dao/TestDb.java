package lania.edu.mx.sunshine.dao;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("No records return from location query.", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("The query doesnt return the expected values and columns",cursor, contentValues);

        // Validate we only have one record
    ...
    public void testWeatherTable() {
        ...
        // Move the cursor to a valid database row
        assertTrue("No records return from weather query", cursor.moveToNext());
